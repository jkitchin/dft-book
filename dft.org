...
This is the reaction energy for 2 Cu_{2}O \right arrow 4 CuO. In \cite{PhysRevB.73.195107}, the experimental reaction is estimated to be  about -3.14 eV.
...
Next we will examine the connection between band structures and density of states.
#+BEGIN_SRC python :results output
from jasp import *
