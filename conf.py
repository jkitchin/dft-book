...
BLOG_AUTHOR = "John Kitchin"  # (translatable)
BLOG_TITLE = "DFT blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://kitchingroup.cheme.cmu.edu/dft-book/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://kitchingroup.cheme.cmu.edu/dft-book/"
BLOG_EMAIL = "jkitchin@andrew.cmu.edu"
BLOG_DESCRIPTION = "Examples of DFT calculations using vasp.Vasp and Python."  # (translatable)
